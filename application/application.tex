...
\href{https://www.abdn.ac.uk/staffnet/documents/UoA\_Annotated\_guidance\%20UKRI\%20R4RI\%20v1.0\%20Aug\%2023.pdf}{Annotated
guidance on preparing a UKRI R4RI}.
}

\input{teamCapabilityToDeliver}
...
\bibliography{linearDynamicalSystems,stateSpaceModels,machineLearning,epilepsy,latentsVariablesModels,deepNeuralNets,monitoringBehavior,dataSharing,misc,eeg,mesoscaleModels,receptiveFields,travelingWaves,others}
\end{document}
